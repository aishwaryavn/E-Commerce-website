...
<html>
	...
	<div class="menubar">
		...
		<ul id="menu">
			...
			<li> <a href="login_admin.php?id=1">Insert a Product</a></li>
			<li> <a href="login_admin.php?id=2">Remove a Product</a></li>
	...
	<div class="content_wrapper">
		...
		<div id="content_area"> 
			...
			<a style="color:yellow" href="cart_display.php"> &nbsp;Go To Cart</a>
